...
float4 VertexOutputMaster0_3_NoInput = float4(0,0,0,0);
 ...
 UNITY_INITIALIZE_OUTPUT(Input, o); // Инициализирует поля структуры по умолчанию

    o.uv_diffuse = v.texcoord.xy; // Пример привязки UV-координат
    o.uv_Normal = v.texcoord.xy; // Пример привязки для нормалей
